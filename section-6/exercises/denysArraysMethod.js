...
const doubledNumbers = numbersTwo.map((num) => num * 2);
...
const numbersThree = [1, 2, 3, 4, 5, 12, 33];
const total = numbersThree.reduce((acc, number) => acc + number, 0);
console.log(total);
//
...
const totalPrice = cart.reduce((acc, productPrice) => acc + productPrice.price, 0);
